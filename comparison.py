...
# For asteroids bigger than Thisbe:
#masteroid=[0,63.13,17.29,13.73,5.78,2.26,2.19,2.10,1.82,1.81,1.59]
# For asteroids bigger than Davida:
#masteroid=[0,63.13,17.29,13.73,5.78]
...
# For asteroids bigger than Thisbe:
#names=["Sun","Mercury","Venus","Earth","Luna","Mars","Jupiter","Saturn","Uranus","Neptune","Apophis","Ceres","Vesta","Pallas","Hygiea","Davida","Interamnia","Eunomia","A804 RA","Psyche","A858 CA"]
# For asteroids bigger than Davida
#names=["Sun","Mercury","Venus","Earth","Luna","Mars","Jupiter","Saturn","Uranus","Neptune","Apophis","Ceres","Vesta","Pallas","Hygiea"]
idEarth=3
idLuna=4
idAst=10
...
# Comment lines 164-166 for no GR correction to Sun                                                                                                              
gr=rebx.load_force("gr")
rebx.add_force(gr)
gr.params["c"] = rbxConstants.C

# Comment lines 171-175 for no GH
...
# Comment lines 178-181 for no radiation pressure forces besides Yarkovsky effect                                                                                                              
...
for i,time in enumerate(times):
  # Uncomment line 245 and the block below to modify Yarkovsky effect in 2029 by instantaneously scaling A2PERT
